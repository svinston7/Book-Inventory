...
// 
//        // Act
//        var result = bookService.findByIsbn("12345");
// 
//        // Assert
//        assertNotNull(result);
//        assertEquals("Test Book", result.getTitle());
...
//        updatedBook.setEdition("Second");
//        updatedBook.setTitle("Updated Book");
//        updatedBook.setPublisherId(102);
// 
//        when(bookDao.findById("12345")).thenReturn(Optional.of(book));
// 
//        // Act
...
// 
//        // Act
//        var result = bookService.findByTitle("Test Book");
// 
//        // Assert
//        assertNotNull(result);
//        assertEquals("Test Book", result.getTitle());
...
//    public void testFindByPublisherId() {
//        // Arrange
//        when(bookDao.findByPublisherId(101)).thenReturn(book);
// 
//        // Act
//        var result = bookService.findByPublisherId(101);
// 
//        // Assert
//        assertNotNull(result);
//        assertEquals(101, result.getPublisherId());
//    }
//}
//
